...
def process_frame(frame, dwell_times, start_time, zone_entry_counts):
    ...
    rect_x, rect_y, rect_w, rect_h = frame.shape[1] - 700, frame.shape[0] - 300, 220, 300
    ...
    cv2.putText(annotated_frame, f'Cheakout: {queue_count}', (rect_x + 10, rect_y + 115), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 1)
...
def process_video_stream(video_file):
    csv_file = 'Shelf_Monitoring_and_Cheakout_Efficiency.csv'
    # Write CSV headers
    with open(csv_file, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(['Timestamp', 'Total Customers', 'Total Visitors', 'Queue Count', 'Shelf Count', 'Current Customers', 'Current Visitor', 'Shelf 1', 'Shelf 2', 'Shelf 3', "Shelf 4"])
    ...
    output_file = "Processed_Shelf_Monitoring_and_Cheakout_Efficiency.mp4"
